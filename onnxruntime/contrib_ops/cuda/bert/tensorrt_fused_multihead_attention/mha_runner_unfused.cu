...
// template <>
// cublasStatus_t inline cublasGemmStridedBatchedEx(
//     handle, cublasOperation_t transa,
...
//       CUBLAS_CALL_THROW(cublasGemmStridedBatchedEx<T>(
//           cublas, CUBLAS_OP_T, CUBLAS_OP_N, S, S, headSize, T(1.f),
...
// void UnfusedMHARunnerFp16::run(const void* qkvPtr, const void* maskPtr, const void* /*seqLens*/,
...
//   half alpha = 1.f;
//   half beta = 0.f;
//   CUBLAS_CALL_THROW(::cublasGemmStridedBatchedEx(
//       mCublas, CUBLAS_OP_T, CUBLAS_OP_N, mS, mS, mHeadSize, &alpha,
...
//   // compute P*V (as V*P)
//   CUBLAS_CALL_THROW(cublasGemmStridedBatchedEx(
//       mCublas, CUBLAS_OP_N, CUBLAS_OP_N, mHeadSize, mS, mS, &alpha,
...
// void UnfusedMHARunnerFp32::run(const void* qkvPtr, const void* maskPtr, const void* /*seqLens*/,
//                                void* output, void* workspace, cudaStream_t stream) {
//   const int* maskIdx = static_cast<const int*>(maskPtr);
...
//   CUBLAS_CALL_THROW(cublasGemmStridedBatched<float>(
//       mCublas, CUBLAS_OP_T, CUBLAS_OP_N, mS, mS, mHeadSize, 1.f,
...
//   CUBLAS_CALL_THROW(cublasGemmStridedBatched<float>(
//       mCublas, CUBLAS_OP_N, CUBLAS_OP_N, mHeadSize, mS, mS, 1.f,
